...
describe('Releases', () => {
  ...
  it('should render create button', () => {
    ...
    expect(screen.getByText('Create release')).toHaveAttribute('href', '/repo/repo/releases/edit')
  })
  ...
  it('should render release link', () => {
    render(<Releases {...props} />)
    expect(screen.getByText('release1')).toHaveAttribute('href', '/repo/repo/releases/edit/1')
  })
